                    ...
                    <div class="container">
                        <div class=" text-light " data-aos="zoom-out-left">
                            <div class="p-md-4 p-sm-1 ">
                                <h2>WELCOME TO KABARAK E-CENTRE</h2>
                                <p>Grow Yourself. </p>
                            </div>
                        </div>
                    </div>
    ...
    <section class=" py-5">
        <div class="container ">
           <div>
            ...
            <div class="py-4">
                <span>
                    Choose from a variety of products, about 150,000
                </span>
            </div>
            <?php
        ...
        <div class="container text-center">
            <div class="row">
                <div class="col-md-12 col-sm-12 py-4">
                    ...
                    <div class="p-5">
                        <span>KABA E: Buy and sell Books, Laptops, Smartphones, Software,tablets, wi-fi routers, E-services, furniture and all kinds of electronic products and accessories. All at
                            the
                            best price in Kenya.
                        </span></div>
                </div>
