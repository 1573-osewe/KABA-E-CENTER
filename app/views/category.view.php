                     ...
                     <?php if(!empty($rows)): ?>
                        ...
                        <?php foreach($rows as $product):?>
                            <div class="col-md-12 col-sm-12 list ">
                                <div class="d-md-flex text-md-start p-1" style="position: relative;">
                                    ...
                                    <div class="text-start px-md-5 px-sm-2"><br>
                                        ...
                                        <small class="px-3"><?php echo esc($product->price_row->name) ?? '' ?></small>
                                        <div class="p-3 ">
                ...
                <div class="col-md-3 col-sm-12  categories-list p-2">
                    <div class="container text-center cardd">
                        <div class="card text-start p-2">
                            <div class="card-body">
                                <strong><i class="bi bi-house-fill h5 pe-3" style="color: #FF9E0F;"></i>New
                                    Laptops</strong>
                                <ul class="card-text">
                                    <li>For sale</li>
                                    <li>To share</li>
